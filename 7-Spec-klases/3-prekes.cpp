...
public:
    Prekes(std::string pavadinimas, unsigned kiekis, double vntKaina) : pavadinimas_(std::move(pavadinimas)),
        ...
        kiekioKaina_ = vntKaina_ * kiekis_ * (1 - nuolaida_);
...
int main() {
    ...
    std::cout << "Įveskite nuolaidos procentinę dalį: ";
    std::cin >> nuolaida;
